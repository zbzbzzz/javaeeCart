                                   ...
                                   <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-12">
                                                                ...
                                                                <div class="product-thumb">
                                                                    <div class="product-inner">
                                                                        <div class="product-image">
                                                                            ...
                                                                            <div class="action-links">
                                                                                <a class="action-btn btn-cart" href="javascript:void(0)" title="加入购物车" pid="${product.pid}"><i class="pe-7s-cart"></i></a>
                                                                                     <!-- <a class="action-btn btn-wishlist" href="#" title="加入收藏"><i class="pe-7s-like"></i></a>     -->                                                                               
                                                                        ...
                                                                        <div class="product-caption">
                                                                            ...
                                                                            <h4 class="product-name"><a href="Common/Product/get?pid=${product.pid}">${product.pname}</a></h4>
                                            ...
                                            <%@include file="../include/productpagination.jsp"%>
                                        </div>
                                    </div> <!-- end of row -->
